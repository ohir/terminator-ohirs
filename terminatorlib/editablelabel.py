...
class EditableLabel(Gtk.EventBox):
    ...
    def set_edit_base(self, text):
        """set the custom text of the label"""
        self._cutext = text
    ...
    def set_custom(self, val=True):
        """Set the customness of the string to True"""
        self._custom = val
        if val and self._cutext:
            self._label.set_text(self._cutext)
        elif not val:
            self._label.set_text(self._autotext)
    ...
    def edit(self):
        ...
        if self._cutext:
            self._entry.set_text (self._cutext)
        else:
            self._entry.set_text (self._label.get_text ())
        self._entry.show ()
